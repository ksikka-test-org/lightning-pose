...
def get_data_module(
    ...
    cfg.dali.base.train.sequence_length = int(cfg.dali.base.train.sequence_length / cfg.training.num_gpus)
    cfg.dali.context.train.batch_size = int(cfg.dali.context.train.batch_size / cfg.training.num_gpus)
